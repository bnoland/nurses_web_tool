...
# TODO: Irritating amount of code duplication. May be able to improve
# performance by using some reactive variables.
server <- function(input, output, session) {
  ...
  # Renders the data table showing the subset of the nurses data selected by the
  # user.
